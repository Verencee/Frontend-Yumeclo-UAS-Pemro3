      ...
      <q-page class="q-pa-xl">
        <q-container>
          <div class="q-my-xl text-center">
            <div class="text-h4 yumeclo-font">
              Your Cosplay Starts with a Dream
            </div>
            <div class="text-subtitle1 q-mt-sm yumeclo-font">
              Sewa kostum karakter favoritmu dengan mudah dan cepat!
            </div>
            <q-btn
              color="primary"
              label="Jelajahi Kostum"
              class="q-mt-md"
              to="/search"
              outline
            />
          ...
          <div class="q-mb-lg text-start">
            <div class="text-h5 yumeclo-font">Katalog terbaru</div>
          </div>
...
onMounted(async () => {
  try {
    ...
    kostum_terbaru.value = res.data.slice(0, 6);
  } catch (error) {
